...
import io.pivotal.pal.tracker.InvoiceApplication;
...
@SpringBootTest(classes = InvoiceApplication.class, webEnvironment = RANDOM_PORT)
...
//        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        ...
        //--- add by watai ---//
        System.out.println(healthJson.jsonString());
        //--- add by watai ---//
